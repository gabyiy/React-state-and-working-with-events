...
function ExpenseItem(props) {
  ...
  const clickHandler = () => {
    setTitle("Updated");
    //aici am creatr o functie care o sa o folosim in button care a executa functia(nu trebuie sa executam functia in buton adica sa ii  pune () la sfarsit pentru ca nu va functiona)
  };
  return (
